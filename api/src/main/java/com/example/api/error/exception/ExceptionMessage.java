...
public class ExceptionMessage {
    ...
    public static final String NAME_TO_LONG = "Nazwa nie może przekraczać 30 znaków";
    public static final String THE_SAME_MIN_POINTS = "Inna ranga posiada już podaną wartość progu punktowego";
}
