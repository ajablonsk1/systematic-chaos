...
export const GRAPH_TASK_JSON = GRAPH_TASK_URL + '/create'
export const FILE_TASK_JSON = COMBAT_TASK_GET_INFO + '/create'
export const INFO_TASK_JSON = INFORMATION_URL + '/create'
export const SURVEY_TASK_JSON = SURVEY_TASK_GET_INFO + '/create'
export const GET_GAME_SUMMARY_STATS = BASE_URL + 'summary'
export const GET_CHAPTER_IMAGES_LIST = BASE_URL + 'file/chapter/images'
export const GET_CHAPTER_IMAGE = BASE_URL + 'file'
export const GET_ACTIVITY_REQUIREMENTS = BASE_URL + 'task/requirements'
export const SET_ACTIVITY_REQUIREMENTS = BASE_URL + 'task/requirements/add'
export const START_EXPEDITION_TASK = BASE_URL + 'task/graph/result/start'
export const SEND_EXPEDITION_ACTION = BASE_URL + 'question/action'
export const GET_CURRENT_EXPEDITION_STATUS = BASE_URL + 'question/get-info'
export const GET_STUDENT_DASHBOARD_STATS = BASE_URL + 'dashboard'
export const DELETE_CHAPTER = GET_CHAPTER_LIST + '/delete'
export const GET_GRAPH_QUESTIONS = GRAPH_TASK_URL + '/map'
export const GET_REGISTRATION_TOKEN = BASE_URL + 'professor/register/token'
